...
enum ModuleCatalog {
    ...
    private static let meeting = ModuleInfo(
        ...
        body: [
            ...
            .text("Вопросы собеседника панель находит сама, и за это приходится платить: реплики собеседника уходят выбранной модели, чтобы она решила, вопрос это или нет. Правилом по знаку вопроса не обойтись — «расскажите про опыт с…» тоже вопрос. Ответ приходит вторым окном по кнопке рядом с репликой."),
